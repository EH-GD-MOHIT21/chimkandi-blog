...
from blogAPP.models import CustomUserModel as cum
...
@csrf_exempt
def sendmail(to,request=None,subject=None,messageper=None,otp=None):
...
def savemodels(email,passwd):
    ...
    user.save()
    user_ = cum(index=user,nested_balance=1.0)
    user_.reward
    user_.save()
